...
class TestSnapChannel:
    ...
    @mark.parametrize("channel_str,expected", [
        # Risk-only channels
        ...
        ("my-track/beta/feature-branch", SnapChannel("my-track", "beta", "feature-branch")),
    ])
...
class TestSnapSpecifier:
    ...
    @mark.parametrize("specifier_str,expected_name,expected_channel", [
        # Simple specifiers
        ...
        ("mysnap=latest/stable/hotfix", "mysnap", SnapChannel("latest", "stable", "hotfix")),
        ("app-name=2.0/edge/experimental", "app-name", SnapChannel("2.0", "edge", "experimental")),
    ...
    def test_valid_specifier_parsing(self, specifier_str, expected_name, expected_channel):
    ...
    @mark.parametrize("specifier_str", [
        # Empty string
        "",
        # Missing channel
        "mysnap=",
